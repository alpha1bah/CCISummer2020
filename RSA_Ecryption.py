...
for i in range(len(message)):
    ASCII_of_original_message[i] = ord(message[i])
    print(message[i],"              ", ASCII_of_original_message[i])
...
print("Char", "      ASCII")
for i in range(len(message)):
    encrypted[i] = ASCII_of_original_message[i]**e % n
    print(chr(encrypted[i]), "            ", encrypted[i])
...
print("Char", "      ASCII")
for i in range(len(message)):
    decrypted[i] = encrypted[i]**d % n
    print(chr(decrypted[i]),"             ", decrypted[i])
